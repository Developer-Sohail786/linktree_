...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Navbar */}
      <nav className="bg-white fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl rounded-full px-5 py-3 shadow-md z-50">
          ...
          <div className="hidden md:flex gap-3 items-center">
            {session ? (
              <>
                <Link
                  href="/dashboard"
                  className="bg-gray-200 px-4 py-2 rounded-lg font-semibold hover:bg-gray-300 transition"
                >
                  Dashboard
                </Link>
                ...
                <button
                  ...
                  className="bg-black text-white px-5 cursor-pointer py-2 rounded-full font-semibold hover:opacity-90 transition"
                >
                  Logout
                </button>
              </>
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="bg-black text-white px-5 py-2 rounded-full font-semibold hover:opacity-90 transition"
                >
                  Signup
                </Link>
              </>
      ...
      {/* Mobile Overlay Menu */}
      {open && (
        <div className="fixed inset-0 bg-white z-100 md:hidden flex flex-col p-6">
            ...
            {session ? (
              <>
                <Link
                  href="/dashboard"
                  onClick={() => setOpen(false)}
                  className="w-1/2 bg-gray-200 py-3 rounded-lg text-center font-semibold"
                >
                  Dashboard
                </Link>
                ...
                <button
                  ...
                  className="w-1/2 bg-black text-white py-3 rounded-full text-center font-semibold"
                >
                  Logout
                </button>
              </>
